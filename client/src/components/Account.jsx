    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <div className="w-full sm:w-auto">
           <select
            ...
            className="w-full sm:w-48 px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
           >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className={`p-6 rounded-lg shadow text-center ${netTotal >= 0 ? 'bg-blue-100' : 'bg-orange-100'}`}>
            ...
            <p className={`text-3xl font-bold ${netTotal >= 0 ? 'text-blue-600' : 'text-orange-500'}`}>₹{netTotal.toFixed(2)}</p>
        </div>
      </div>
